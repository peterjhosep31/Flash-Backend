          ...
          if (!err) {
            ...
            `,
              ...
              (err, info) => {
                if (err) {
                  console.log(
                    "_________________________ERROR EMAIL_____________________________"
                  );
                  console.log(err);
                  console.log(
                  ...
                  console.log(
                    "_________________________INFO EMAIL_____________________________"
                  );
                  console.log(info);
                  console.log(
                    "_________________________________________________________________"
...
controllerSesion.login = async (req, res) => {
  ...
  req.getConnection((err, conn) => {
    if (!err) {
      conn.query(
        "SELECT name_customer, pasword_customer FROM customer WHERE email_customer = ?",
        [email],
        (err, rows) => {
          if (!err) {
            if (rows.length > 0) {
