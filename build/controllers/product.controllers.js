...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // import { object, number, string } from "yup";
var controllerProduct = {};

//ROTER POST OF PRODUCTS
controllerProduct.postProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var availabilityProduct, idProduct, nameProduct, descriptionProduct, availability, amountProduct, price, img, category, offer, store, imgProduct, urlImgProduct, idImgProduct;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          availability = req.body.availabilityProduct;
          ...
          _context.next = 14;
          return (0, _uploadImagesUser["default"])(img);
        case 14:
          imgProduct = _context.sent;
          urlImgProduct = imgProduct.secure_url;
          idImgProduct = imgProduct.public_id;
...
controllerProduct.putProduct = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var idProduct, nameProduct, descriptionProduct, availabilityProduct, amountProduct, idEmployee, passwordEmployee, product;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          nameProduct = req.body.nameProduct;
          descriptionProduct = req.body.descriptionProduct;
          availabilityProduct = req.body.availabilityProduct;
          amountProduct = req.body.amountProduct;
          idEmployee = req.body.idEmpleyee;
...
controllerProduct.deleteProduct = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var idProduct, idEmployee, passwordEmployee, product;
