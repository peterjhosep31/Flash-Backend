...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } //TODO:Ruta     http://localhost:3105/authUser/signInUser
...
controllerAuth.singIn = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var emailUser, passwordUser;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          emailUser = req.body.data.email;
          passwordUser = req.body.data.password;
          _dataBase["default"].query("SELECT * FROM administrator WHERE email_center = ?", [emailUser], /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(err, rows) {
              var passwordUserDB, passwordCompare, user, rolAdmin, accessToken;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    passwordUserDB = rows[0].password_admin;
                    _context3.next = 5;
                    return _encryptPassword["default"].matchPassword(passwordUser, passwordUserDB);
                  case 5:
                  ...
                  case 17:
                    return _context3.abrupt("return", res.status("402").send({
                  ...
                  case 20:
                    if (rows.length === 0) {
                      _dataBase["default"].query("SELECT * FROM store WHERE email_store = ?", [emailUser], /*#__PURE__*/function () {
                        var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(err, rows) {
                          var _passwordUserDB, _passwordCompare, _user, _rolAdmin, _accessToken;
                          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                            while (1) switch (_context2.prev = _context2.next) {
                              case 0:
                                ...
                                _passwordUserDB = rows[0].password_store;
                                console.log(_passwordUserDB);
                                _context2.next = 6;
                                return _encryptPassword["default"].matchPassword(passwordUser, _passwordUserDB);
                              case 6:
                                _passwordCompare = _context2.sent;
                                console.log(_passwordCompare);
                                if (!_passwordCompare) {
                                  _context2.next = 17;
                                  break;
                                }
                              ...
                              case 17:
                                return _context2.abrupt("return", res.status("402").send({
                              ...
                              case 20:
                                ...
                                return _dataBase["default"].query("SELECT * FROM customer WHERE email_customer = ?", [emailUser], /*#__PURE__*/function () {
                                  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, rows) {
                                    var _passwordUserDB2, _passwordCompare2, _rolAdmin2, _user2, _accessToken2;
                                    return _regeneratorRuntime().wrap(function _callee$(_context) {
                                      while (1) switch (_context.prev = _context.next) {
                                        case 0:
                                          ...
                                          _passwordUserDB2 = rows[0].password_customer;
                                          _context.next = 5;
                                          return _encryptPassword["default"].matchPassword(passwordUser, _passwordUserDB2);
                                        case 5:
